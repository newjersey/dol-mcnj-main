export const TrainingProviderPageStrings: Record<string, string> = {
  header: "Register or renew your organization's offerings on the Eligible Training Provider List",
