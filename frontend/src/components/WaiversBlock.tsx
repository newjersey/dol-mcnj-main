...
export const WaiversBlock = (props: Props): ReactElement => {
    ...
    const dataMissingOrSource =
        props.data === STAT_MISSING_DATA_INDICATOR
            ? t("WaiversBlock.missingDataExplanation")
            : `${t("WaiversBlock.dataSourceLabel")} ${props.dataSource ?? t("WaiversBlock.defaultDataSource")}`;
