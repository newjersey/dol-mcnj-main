      ...
      <div className="split fdc fac bg-light-green">
        <div className="paxxl">
          <div className="fdr fjc fac mhl mtxxl mbd">
            <img className="nj-logo mrd" src={njLogo} alt="New Jersey innovation logo"/>
            <h1>Training<br/>Explorer</h1>
          </div>
          <div>
            <h2 className="subtitle mld">Find the training you need to<br/>get the job that you want</h2>
          </div>
        </div>
      </div>
      <div className="split">
        <div className="paxxl">
          <div className="mhl mvxl prxl">
            ...
            <p className="info">Find training to prepare you for a promotion, better job, or even a career change</p>
            <Searchbar onSearch={(searchQuery: string): Promise<void> => navigate(`/search/${searchQuery}`)}/>
          </div>
          <hr/>
