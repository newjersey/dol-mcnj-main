...
<p>Most accountants and auditors need at least a bachelor&rsquo;s degree in accounting or a related field. Certification, including the Certified Public Accountant (CPA) credential, can improve job prospects. &nbsp;</p>
<h3>Education</h3>
<p>Most accountant and auditor positions require at least a bachelor&rsquo;s degree in accounting or a related field. Some employers prefer to hire applicants who have a master&rsquo;s degree, either in accounting or in business administration with a concentration in accounting.</p>
<p>A few universities and colleges offer specialized programs, such as a bachelor&rsquo;s degree in internal auditing. In some cases, those with associate&rsquo;s degrees, as well as bookkeepers and accounting clerks who meet the education and experience requirements set by their employers, get junior accounting positions and advance to accountant positions by showing their accounting skills on the job.</p>
...
<p>CPAs are licensed by their state&rsquo;s Board of Accountancy. Becoming a CPA requires passing a national exam and meeting other state requirements. Almost all states require CPA candidates to complete 150 semester hours of college coursework to be licensed, which is 30 hours more than the usual 4-year bachelor&rsquo;s degree. Many schools offer a 5-year combined bachelor&rsquo;s and master&rsquo;s degree to meet the 150-hour requirement, but a master&rsquo;s degree is not required.</p>
...
<p>Accountants and auditors who have earned professional recognition, especially as Certified Public Accountants (CPAs), should have the best prospects. Job applicants who have a master&rsquo;s degree in accounting or a master&rsquo;s degree in business administration (MBA) with a concentration in accounting also may have an advantage.</p>
			','html','
...
<p><a class="external" href="http://www.aacsb.edu/" target="_blank" rel="noopener noreferrer">AACSB International&mdash;The Association to Advance Collegiate Schools of Business</a></p>
...
<p>Most employers require a candidate to have a bachelor&rsquo;s degree in accounting or a related field. Certification within a specific field of accounting improves job prospects. For example, many accountants become Certified Public Accountants (CPAs).</p>
		','html','
...
<p><strong><em>Internal auditors</em></strong> check for mismanagement of an organization&rsquo;s funds. They identify ways to improve the processes for finding and eliminating waste and fraud. The practice of internal auditing is not regulated, but The Institute of Internal Auditors (IIA) provides generally accepted standards.</p>
<p><strong><em>External auditors</em></strong><em> </em>perform similar duties to internal auditors, but are employed by an outside organization, rather than the one they are auditing. They review clients&rsquo; financial statements and inform investors and authorities that the statements have been correctly prepared and reported.</p>
<p><strong><em>Information technology auditors</em></strong> are internal auditors who review controls for their organization&rsquo;s computer systems to ensure that the financial data comes from a reliable source.</p>
			','html','
...
<p>Most accountants and auditors work in offices, but some work from home. Although they complete much of their work alone, they sometimes work in teams with other accountants and auditors. Accountants and auditors may travel to their clients&rsquo; places of business.</p>
...
<h3>Education</h3>
<p>Many actors enhance their skills through formal dramatic education. Many who specialize in theater have bachelor&rsquo;s degrees, but a degree is not required.</p>
<p>Although some people succeed in acting without getting a formal education, most actors acquire some formal preparation through a theater company&rsquo;s acting conservatory or a university drama or theater arts program. Students can take college classes in drama or filmmaking to prepare for a career as an actor. Classes in dance or music may help as well.</p>
...
<h3>Important Qualities</h3>
<p><strong><em>Creativity.</em></strong> Actors interpret their characters&rsquo; feelings and motives in order to portray the characters in the most compelling way.</p>
...
<p><strong><em>Speaking skills.</em></strong> Actors&mdash;particularly stage actors&mdash;must say their lines clearly, project their voice, and pronounce words so that audiences understand them.</p>
...
<h3>Advancement</h3>
<p>As an actor&rsquo;s reputation grows, he or she may work on bigger projects or in more prestigious venues. Some actors become <a href="/ooh/entertainment-and-sports/producers-and-directors.htm" title="Producers and Directors">producers and directors</a>.</p>
			','html','
...
<h3>Job Prospects</h3>
<p>Actors face intense competition for jobs. Most roles, no matter how minor, have many actors auditioning for them. For stage roles, actors with a bachelor&rsquo;s degree in theater may have a better chance of landing a part than those without one.</p>
			','html','
...
<p><a class="external" href="http://www.actorsequity.org/" target="_blank" rel="noopener noreferrer">Actors&rsquo; Equity Association</a></p>
...
<p>Actors express ideas and portray characters in theater, film, television, and other performing arts media. They interpret a writer&rsquo;s script to entertain or inform an audience.</p>
<h3>Duties</h3>
...
<li>Research their character&rsquo;s personal traits and circumstances to portray the characters more authentically to an audience</li>
...
<li>Perform the role, following the director&rsquo;s directions</li>
</ul>
<p>Most actors struggle to find steady work, and few achieve recognition as stars. Some work as &ldquo;extras&rdquo;&mdash;actors who have no lines to deliver but are included in scenes to give a more realistic setting. Some actors do voiceover or narration work for animated features, audiobooks, or other electronic media.</p>
...
<p>Actuaries need a bachelor&rsquo;s degree, typically in mathematics, actuarial science, statistics, or some other analytical field. Students must complete coursework in economics, applied statistics, and corporate finance, and must pass a series of exams to become certified professionals.</p>
<h3>Education</h3>
...
<p>Students also should take classes outside of mathematics and business to prepare them for a career as an actuary. Coursework in computer science, especially programming languages, and the ability to use and develop spreadsheets, databases, and statistical analysis tools, are valuable. Classes in writing and public speaking will improve students&rsquo; ability to communicate in the business world.</p>
<h3>Licenses, Certification, and Registrations</h3>
<p>Two professional societies&mdash;the <a class="external" href="http://www.casact.org/" target="_blank" rel="noopener noreferrer">Casualty Actuarial Society</a> (CAS) and the <a class="external" href="https://www.soa.org/member/" target="_blank" rel="noopener noreferrer">Society of Actuaries</a> (SOA)&mdash;sponsor programs leading to full professional status. The CAS and SOA offer two levels of certification: associate and fellow.</p>
<p>The CAS certifies actuaries who work in the property and casualty field, which includes automobile, homeowners, medical malpractice, and workers&rsquo; compensation insurance.</p>
...
<p><strong><em>Interpersonal skills.</em></strong> Actuaries serve as leaders and members of teams, so they must be able to listen to other people&rsquo;s opinions and suggestions before reaching a conclusion.</p>
...
<p>U.S. Department of Labor and U.S. Department of the Treasury&rsquo;s <a class="external" href="http://www.irs.gov/Tax-Professionals/Enrolled-Actuaries" target="_blank" rel="noopener noreferrer">Joint Board for the Enrollment of Actuaries</a></p>
...
<p>Although educational requirements for administrative services managers vary by&nbsp;organization and the work they do, they usually must have a bachelor&rsquo;s degree and&nbsp;related work experience.</p>
<h3>Education</h3>
<p>Administrative services managers typically need a bachelor&rsquo;s degree, usually in business or a related field. However, some people enter the occupation with a high school diploma.</p>
...
<h3>Important Qualities</h3>
<p><strong><em>Analytical skills.</em></strong> Administrative services managers must be able to review an organization&rsquo;s procedures for ways to improve efficiency.</p>
...
<p>Although administrative services managers&rsquo; educational requirements vary by organization and the work they do, they usually must have a bachelor&rsquo;s degree and related work experience.</p>
		','html','
			<h4>More Information, Including Links to O*NET</h4>
...
<p><strong><em>Records and information managers</em></strong> develop, monitor, and manage an organization&rsquo;s records. They provide information to&nbsp;<a href="/ooh/management/top-executives.htm" title="Top Executives"><u>chief executives</u></a> and ensure that employees follow records and information management guidelines. They may direct the operations of onsite or offsite records facilities. These managers also work closely with an organization&rsquo;s <a href="/ooh/legal/lawyers.htm" title="Lawyers"><u>attorneys</u></a> and its technology and business operations staff. Records and information managers do not handle medical records, which are administered by <a href="/ooh/management/medical-and-health-services-managers.htm" title="Medical and Health Services Managers"><u>medical and health services managers</u></a>.</p>
			','html','
...
<p>Adult literacy and high school equivalency diploma teachers who work in public schools must have at least a bachelor&rsquo;s degree and a license or certification.</p>
<h3><strong>Education</strong></h3>
<p>Adult literacy and high school equivalency diploma teachers in public schools must have at least a bachelor&rsquo;s degree. Some community colleges may prefer to hire those with a master&rsquo;s degree or graduate coursework in adult education or English as a Second Language (ESL).</p>
...
<p>To obtain a license, adult literacy and high school equivalency diploma teachers typically need a bachelor&rsquo;s degree and must complete a student-teaching program. For more information, contact the director of adult education for your state. Contact information is available from the <a class="external" href="https://www2.ed.gov/about/offices/list/ovae/pi/AdultEd/index.html" target="_blank" rel="noopener noreferrer">U.S. Department of Education</a>.</p>
...
<p><strong><em>Cultural sensitivity.</em></strong> Teachers work with students from a variety of cultural, educational, and economic backgrounds. They must be respectful of their students&rsquo; backgrounds and be understanding of their concerns.</p>
...
<p><em>Career Outlook</em>: &ldquo;<span><a href="https://www.bls.gov/careeroutlook/2016/article/education-jobs-teaching-for-a-living.htm">Teaching for a living</a></span>."</p>
...
<li>Adapt teaching methods based on students&rsquo; strengths and weaknesses</li>
...
<li>Monitor students&rsquo; progress</li>
...
<p>Students&rsquo; educational level and skills are assessed before they enter these programs. Teachers may conduct the assessments; however, sometimes another staff member assesses students. Based on the results of the assessment and the student&rsquo;s goals, teachers develop an education plan.</p>
<p>Teachers must formally evaluate their students periodically to determine their progress and potential to go on to the next level of classes. However, teachers may informally evaluate their students&rsquo; progress continually.</p>
