...
const cipCodeUtils_1 = require("../../domain/search/cipCodeUtils");
class PostgresSearchClient {
    constructor(connection) {
        this.search = (searchQuery) => {
            console.log(`Executing search for query: "${searchQuery}"`);
            if ((0, cipCodeUtils_1.isCipCodeQuery)(searchQuery)) {
                return this.searchByCipCode(searchQuery);
            }
            return this.searchByFullText(searchQuery);
        };
        this.searchByCipCode = (searchQuery) => {
            const normalizedCipCode = (0, cipCodeUtils_1.normalizeCipCode)(searchQuery);
        ...
        this.searchByFullText = (searchQuery) => {
