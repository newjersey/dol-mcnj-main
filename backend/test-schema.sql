...
\restrict grrtu2TbevuHUZxSTKHqacMQxyCVXtAMQGc1lmRAYDX2ERVDwKTcmU6LI0zYR5D
...
CREATE TABLE public.blsoccupationhandbook (
...
CREATE TABLE public.indemandcips (
...
CREATE TABLE public.indemandsocs (
...
CREATE TABLE public.localexceptioncips (
    soc character varying(16),
...
CREATE TABLE public.oesestimates (
    area integer,
    area_title text,
    area_type integer,
    naics integer,
...
CREATE TABLE public.oeshybridcrosswalk (
...
CREATE TABLE public.onlineprograms (
...
CREATE TABLE public.outcomes_cip (
    providerid character varying(16),
    cipcode character varying(16),
...
CREATE SEQUENCE public.outcomes_cip_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.programtokens (
    tokens tsvector,
    programid character varying(8) NOT NULL
);
...
CREATE TABLE public.soc2010to2018crosswalk (
    soccode2010 character varying(16),
    soctitle2010 character varying(256),
    soccode2018 character varying(16),
    soctitle2018 character varying(256)
...
CREATE TABLE public.soccipcrosswalk (
...
CREATE TABLE public.socdefinitions (
...
ALTER TABLE ONLY public.etpl
    ADD CONSTRAINT etpl_pkey PRIMARY KEY (programid);
...
--
-- Name: outcomes_cip outcomes_cip_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.outcomes_cip
    ADD CONSTRAINT outcomes_cip_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.programtokens
    ADD CONSTRAINT programtokens_pkey PRIMARY KEY (programid);
...
\unrestrict grrtu2TbevuHUZxSTKHqacMQxyCVXtAMQGc1lmRAYDX2ERVDwKTcmU6LI0zYR5D
