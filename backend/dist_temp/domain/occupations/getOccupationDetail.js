...
const searchTrainings_1 = require("../search/searchTrainings");
const getOccupationDetailFactory = (getOccupationDetailFromOnet, getEducationText, getSalaryEstimate, getOpenJobsCount, dataClient) => {
    return (soc) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const getTrainingResults = (soc) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const trainings = yield (0, searchTrainings_1.searchTrainingsFactory)(dataClient)({ searchQuery: soc, limit: 4 });
