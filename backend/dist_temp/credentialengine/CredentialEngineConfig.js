...
exports.getRecordAPI = exports.searchAPI = void 0;
const tslib_1 = require("tslib");
const axios_1 = tslib_1.__importDefault(require("axios"));
exports.searchAPI = axios_1.default.create({
...
exports.getRecordAPI = axios_1.default.create({
...
exports.searchAPI.interceptors.response.use(undefined, (error) => {
    return errorHandler(error);
});
exports.getRecordAPI.interceptors.response.use(undefined, (error) => {
    return errorHandler(error);
});
