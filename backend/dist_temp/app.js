...
const CredentialEngineFactory_1 = require("./domain/credentialengine/CredentialEngineFactory");
const getOccupationDetailByCIP_1 = require("./domain/occupations/getOccupationDetailByCIP");
const helmet_1 = tslib_1.__importDefault(require("helmet"));
const allTrainings_1 = require("./domain/search/allTrainings");
dotenv.config();
