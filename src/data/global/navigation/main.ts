export const MAIN_NAV_DATA = {
  title: "My Career NJ (2.1 - With Career Pathways)",
  itemId: "6z5HiOP5HqvJc07FURpT8Z",
  en: {
    topLevelItemsCollection: {
      items: [
        ...
        },
        {
          ...
          itemId: "xjYLs9NJa1oQj6dZhn4j1",
          subItemsCollection: {
            items: [
              {
                copy: "NJ Career Navigator",
                url: "/navigator",
                itemId: "3XKFKa71iJJw2ivyak3BU5",
              },
              {
