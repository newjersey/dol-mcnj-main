...
const Content = ({
  ...
  const showDropdown =
    process.env.REACT_APP_FEATURE_SHOW_PINPOINT_SEGMENTS === "true";
  ...
  return (
    <div
      className={`update-content${fixed ? " fixed" : ""}${open ? " open" : ""}`}
    >
      {fixed && (
        <button
          ...
          {success ? (
            <div className="heading-wrap status">
              ...
              <p className="status-message">
                If this is the first time you&apos;ve subscribed to{" "}
                {process.env.REACT_APP_SITE_NAME}, you&apos;ll see a
                confirmation email in your inbox to confirm your subscription.
                If you don&apos;t see that email, be sure to check your spam and
                junk folders.
              </p>
              <p>
                Read about out{" "}
            ...
            <div className="heading-wrap status">
              ...
              <p className="status-message">
                ...
                alerted. Please try again and if the issue persists you can{" "}
            ...
            <>
              <div className="heading-wrap">
                ...
                <p className="heading-tag">
                  Want updates on new tools and features from{" "}
              ...
              <form className="usa-form" onSubmit={handleSubmit}>
                <div className="usa-form-group">
                  ...
                  <p className="copy">
                    A red asterisk (<span className="require-mark">*</span>)
    ...
    <div className={`update-notifier${className ? ` ${className}` : ""}`}>
      {isDrawer ? (
        <>
          ...
          <button
            className="usa-button primary toggle"
            onClick={() => {
              setOpen(!open);
            }}
          >
