...
interface OutcomeDetailsProps {
  outcomes: ProgramOutcome | undefined;
  title?: string;
  className?: string;
  onInfoClick?: () => void;
}

export const OutcomeDetails = ({ outcomes, title = "Consumer report card", className = "", onInfoClick }: OutcomeDetailsProps) => {
    ...
    <>
      <div className={`bg-teal-50 rounded-lg p-6 ${className}`}>
        <div className="flex items-center justify-between mb-6">
          ...
          {showCrcInfoFeature && onInfoClick && (
            <button
              onClick={onInfoClick}
