...
export const cardRowClasses =
  "grid grid-cols-1 tablet:grid-cols-2 items-start tabletXl:grid-cols-3 gap-8";
...
export default async function MediaPressPage() {
  ...
  return (
    <div className="page careerNavigator">
      ...
      <section className="container flex tabletXl:flex-row-reverse flex-col tabletXl:items-start items-center gap-12">
        <SideNav label={pageData[lang].tocLabel} />
        <div
          id="pageCopySection"
          className="flex flex-col gap-24 mb-24 tabletXl:w-[calc(100%-300px)]"
        >
          <div>
            <SectionHeading
              withIds
